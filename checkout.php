        ...
        <div class="container "><br></br>
            <div class="row" style="">
                <div class="detailhead">
                    ...
                    <label class="mylbm" style="cursor: pointer;" id="cu">Click Here and get coupan code
                    ...
                    <form action="" method="post" name="cupform">
                        <div class="form-group col-md-5 animated shake">
                            ...
                            <div class="input-group">
                                <input type="text" name="name" placeholder="Fill Your Name" style="padding: 15px;"
                                    required="" pattern='^[0-9]+$' class="form-control" />
                                <div class="input-group-addon regi">
                                    <button type="submit" name="coupon" style="border: none; background: #f8a631;"> <i
